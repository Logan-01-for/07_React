...
//              부모 자식간 관계가 중찹된 구조에서 데이터를 전달 하는데 있어 불필요한
...
// Context : react 에서 컴포넌트 계층 구조를 통해
...
const Exam6 = () => {
  ...
  // Context.Provider : 하위 컴포넌트에게 데이터를 전달할 때 (제공 할 때) 사용
  return (
...
const Child2 = () => {
  const contextValu = useContext(UserContext);
  return (
    <>
      <h1>
