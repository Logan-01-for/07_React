...
import youtube from "../assets/youtube.img.jpg";
...
const Exam5_5 = () => {
  ...
  // JS 내장 함수 중 배열을 하나씩 순차접근해서 콜백 함수 내에 있는 내용 수행 후
  // 새로운 배열을 만들어 반환 -> map
  // [ <li>짱구</li>, <li>유리</li>, <li>철수</li>, <li>훈이</li>, <li>맹구</li> ]

  const listItems = members.map((mem, index) => <li>{mem}</li>);
  // Each child in a list should have a unique "key" pro
